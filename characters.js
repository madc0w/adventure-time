...
const interactionFuncs = {
	followSameType(roomCharacter, roomCharacter2) {
		...
		if (character.id == character2.id) {
			const character1X =
				roomCharacter.location.x * getValue(state.room, 'width');
			const character1Y =
				roomCharacter.location.y * getValue(state.room, 'height');
			const character2X =
				roomCharacter2.location.x * getValue(state.room, 'width');
			const character2Y =
				roomCharacter2.location.y * getValue(state.room, 'height');
			const dx = character2X - character1X;
			const dy = character2Y - character1Y;
			const dist = Math.sqrt(dx * dx + dy * dy);
			if (dist > 0) {
				const factor =
					((character.followFactor || 0.05) * (character.speed || 0.004)) /
					dist;
	...
	moveTowardPlayer(roomCharacter, roomCharacter2) {
		...
		if (characters.player == character2) {
			...
			const factor =
				(character.speed || 0.04) *
				(dist > targetDist ? -dist / targetDist : targetDist / dist);
			// console.log(factor);
...
characters = {
	player: {
		...
		width: 0.05,
		height: 0.1,
		idleFrames: ['player standing 01.png', 'player standing 02.png'],
		up: ['player up 01.png', 'player up 02.png'],
		down: ['player down 01.png', 'player down 02.png'],
		left: ['player left 01.png', 'player left 02.png'],
		right: ['player right 01.png', 'player right 02.png'],
		dieFrames: [
			'player dead 01.png',
			'player dead 02.png',
			'player dead 03.png',
		...
		wielding: {
			enchantedSword: {
				...
				idleFrames: ['player standing wielding enchanted sword.png'],
			...
			venomDagger: {
				...
				idleFrames: ['player standing wielding venom dagger.png'],
				up: ['player up wielding 01.png', 'player up wielding 02.png'],
				down: [
			...
			electrosmasher: {
				...
				idleFrames: ['player standing wielding electrosmasher.png'],
				up: ['player up wielding 01.png', 'player up wielding 02.png'],
				down: [
			...
			bow: {
				...
				idleFrames: ['player standing wielding bow.png'],
				up: ['player up wielding 01.png', 'player up wielding 02.png'],
				down: [
		...
		attack: {
			enchantedSword: {
				left: ['player left strike enchanted sword.png'],
				right: ['player right strike enchanted sword.png'],
			},
			venomDagger: {
				left: ['player left strike venom dagger.png'],
				right: ['player right strike venom dagger.png'],
			},
			electrosmasher: {
				left: ['player left strike electrosmasher.png'],
				right: ['player right strike electrosmasher.png'],
			},
			bow: {
				// left: [
	...
	doomScreen: {
		...
		dieFrames: ['doom screen dead 01.png', 'doom screen dead 02.png'],
		attackFrames: ['doom screen attack 01.png'],
		attackPrepFrames: ['doom screen attack-prep 01.png'],
	...
	zlakik: {
		...
		dieFrames: ['zlakik 01.png'],
		attackFrames: ['zlakik attack 01.png'],
		attackPrepFrames: ['zlakik 01.png'],
		// move: [
		// 	moveFuncs.random,
		// ],
	...
	megabug: {
		...
		dieFrames: ['megabug v2 die 01.png', 'megabug v2 die 02.png'],
		attackFrames: [
	...
	voidWraith: {
		...
		dieFrames: [
			'void wraith dead 01.png',
			'void wraith dead 02.png',
			'void wraith dead 03.png',
		],
		attackFrames: [
			'void wraith attack 01.png',
			'void wraith attack 02.png',
			'void wraith attack 03.png',
			'void wraith attack 02.png',
		],
